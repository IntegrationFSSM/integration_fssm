...
var I18N = mergeClubI18n({
  fr: {
    ...
    'club.empreinte': 'Exprimez votre créativité et développez vos talents artistiques avec le club théâtre.',
    'club.raic': "Club de robotique et intelligence artificielle pour les passionnés de technologies avancées.",
    'club.chorale': 'Rejoignez la chorale pour partager votre passion de la musique et du chant.',
    ...
    'club.debat': "Développez l'éloquence, l'argumentation et la prise de parole en public.",
    ...
    'club.mindup': 'Développement personnel, mindset et bien-être pour révéler le potentiel des étudiants.',
  ...
  en: {
    ...
    'club.empreinte': 'Express your creativity and artistic talent with the theatre club.',
    'club.raic': 'Robotics and artificial intelligence for students passionate about advanced tech.',
    'club.chorale': 'Join the choir and share your love of music and singing.',
    ...
    'club.debat': 'Develop eloquence, argumentation and public speaking.',
    ...
    'club.mindup': 'Personal development, mindset and well-being for students.',
  ...
  ar: {
    ...
    'club.empreinte': 'عبّر عن إبداعك وموهبتك الفنية مع نادي المسرح.',
    'club.raic': 'نادي الروبوتات والذكاء الاصطناعي لعشاق التقنيات المتقدمة.',
    'club.chorale': 'انضم إلى الجوقة وشارك شغفك بالموسيقى والغناء.',
    ...
    'club.debat': 'طوّر الفصاحة والحجاج والحديث أمام الجمهور.',
    'club.meraki': 'رقص وتعبير فني وشغف في كل حركة.',
    'club.ayadi': 'تضامن وعمل إنساني في خدمة الخير العام.',
    'club.mindup': 'تنمية ذاتية وعقلية إيجابية ورفاه للطلاب.',
